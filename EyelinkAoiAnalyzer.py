...
def print_all_fixations(participants, use_fixation_length=False):
    ...
    for participant_id in participants:
        with open(join("input", "fixations", participant_id + ".pkl"), 'rb') as input:
    ...
    if use_fixation_length:
        output_file_path = join("output", "aoi_histogram_time.csv")
    else:
        output_file_path = join("output", "aoi_histogram_count.csv")
...
def write_participants_to_csv_file(participants, aoi_fixations_per_comprehension, use_fixation_length):
    ...
    # write objects to file as giant csv
    if use_fixation_length:
        output_file_path = join("output", "aoi_task_participant_time.csv")
    else:
        output_file_path = join("output", "aoi_task_participant_count.csv")
...
def write_comprehension_to_csv_file_bar(participants, aoi_fixations_per_comprehension, use_fixation_length):
    ...
    # write objects to file as giant csv
    if use_fixation_length:
        output_file_path = join("output", "aoi_task_comprehension_time_bar.csv")
    else:
        output_file_path = join("output", "aoi_task_comprehension_count_bar.csv")
...
def write_comprehension_to_csv_file(aoi_fixations_per_comprehension, use_fixation_length):
    ...
    # write objects to file as giant csv
    if use_fixation_length:
        output_file_path = join("output", "aoi_task_comprehension_time.csv")
    else:
        output_file_path = join("output", "aoi_task_comprehension_count.csv")
