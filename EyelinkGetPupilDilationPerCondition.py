...
def main():
    ...
    for participant in participants:
        pupil_dilation = []
        print("Reading file...")
        eyetracking_input_file_path = join("input", participant + ".asc")
        ...
        with open(eyetracking_input_file_path) as input_file:
            ...
            for i, line in enumerate(input_file):
                ...
                if line[0].isdigit():
                    ...
                    if OgamaConnector.is_number(gaze_x):
        ...
        with open(join("input", "fixations", participant + "_pupil_data_raw.pkl"), 'wb') as output:
