...
def write_participants_to_csv_file(participants, results_x, results_y, weighted):
    ...
    if weighted:
        output_file_path = join("output", "average_offset_participant_weighted.csv")
    else:
        output_file_path = join("output", "average_offset_participant.csv")
...
def write_averages_to_csv_file(results_x, results_y, weighted):
    ...
    # write objects to file as giant csv
    if weighted:
        output_file_path = join("output", "average_offset_condition_weighted.csv")
    else:
        output_file_path = join("output", "average_offset_condition.csv")
